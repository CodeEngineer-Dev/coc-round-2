const { Block, Platformer } = (function () {
  // Constants
  const HVEL = 2; // PLEASE ADJUST AS NECESSARY, I HAVE NOT PLAYTESTED THESE CONSTANTS MAINLY
  ...
  class Block {
     ...
     * @param {Number} z
     */
    constructor(x, y, z, rendererScene) {
      ...
      this.renderComponent = new RenderComponent("cube/Cube");
